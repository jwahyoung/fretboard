...
function generateLookup(octaveOffset) {
  if (octaveOffset === void 0) {
    octaveOffset = 0;
  }

  var base = 4;
  return exports.pitchClass.map(function (x, i) {
    return {
      note: x,
...
function generateLookupRange(start, end) {}

exports.generateLookupRange = generateLookupRange;
},{}],"node_modules/lit-html/directives/unsafe-html.js":[function(require,module,exports) {
"use strict";
...
},{"../lib/parts.js":"node_modules/lit-html/lib/parts.js","../lit-html.js":"node_modules/lit-html/lit-html.js"}],"src/fretboard.ts":[function(require,module,exports) {
"use strict";
...
exports.fretboard = function (strings, activeNotes, hideAllNotes) {
  if (activeNotes === void 0) {
    activeNotes = constants_1.pitchClass;
  }

  if (hideAllNotes === void 0) {
    hideAllNotes = false;
  }

  var _a = strings.reduce(function (p, c) {
    return {
      maxOffset: Math.max(p.maxOffset, c.offset),
      minOffset: Math.min(p.minOffset, c.offset)
    };
  }, {
    maxOffset: 0,
    minOffset: 0
  }),
      minOffset = _a.minOffset,
      maxOffset = _a.maxOffset;

  var numberOfFrets = strings.reduce(function (p, c) {
    return Math.max(p, c.frets + Math.abs(minOffset) + maxOffset);
  }, -Infinity);

  var noteDisplay = function noteDisplay(note) {
    return lit_html_1.html(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n\t\t<div class=\"fretboard-note\">\n\t\t\t<span class=\"", " tag ", " ", "\">\n\t\t\t\t", "\n\t\t\t</span>\n\t\t</div>\n\t"], ["\n\t\t<div class=\"fretboard-note\">\n\t\t\t<span class=\"", " tag ", " ", "\">\n\t\t\t\t", "\n\t\t\t</span>\n\t\t</div>\n\t"])), hideAllNotes ? 'is-invisible' : '', activeNotes.indexOf(note) > -1 ? 'active' : '', note.indexOf(',') === -1 ? 'is-white' : 'is-dark', note.replace(',', '/'));
  };

  return lit_html_1.html(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n\t\t<div id=\"notation\">\n\t\t\t<div class=\"table-container\">\n\t\t\t\t<table class=\"table fretboard is-fullwidth is-hoverable is-narrow\">\n\t\t\t\t\t<thead>\n\t\t\t\t\t\t<tr>\n\t\t\t\t\t\t\t", "\n\t\t\t\t\t\t</tr>\n\t\t\t\t\t</thead>\n\t\t\t\t\t<tbody class=\"has-background-grey-lighter\">\n\t\t\t\t\t", "\n\t\t\t\t\t</tbody>\n\t\t\t\t\t<tfoot>\n\t\t\t\t\t\t<tr>\n\t\t\t\t\t\t\t", "\n\t\t\t\t\t\t</tr>\n\t\t\t\t\t</tfoot>\n\t\t\t\t</table>\n\t\t\t</div>\n\t\t</div>\n\t"], ["\n\t\t<div id=\"notation\">\n\t\t\t<div class=\"table-container\">\n\t\t\t\t<table class=\"table fretboard is-fullwidth is-hoverable is-narrow\">\n\t\t\t\t\t<thead>\n\t\t\t\t\t\t<tr>\n\t\t\t\t\t\t\t", "\n\t\t\t\t\t\t</tr>\n\t\t\t\t\t</thead>\n\t\t\t\t\t<tbody class=\"has-background-grey-lighter\">\n\t\t\t\t\t", "\n\t\t\t\t\t</tbody>\n\t\t\t\t\t<tfoot>\n\t\t\t\t\t\t<tr>\n\t\t\t\t\t\t\t", "\n\t\t\t\t\t\t</tr>\n\t\t\t\t\t</tfoot>\n\t\t\t\t</table>\n\t\t\t</div>\n\t\t</div>\n\t"])), Array(numberOfFrets + 1).fill('').map(function (x, index) {
    return lit_html_1.html(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n\t\t\t\t\t\t\t\t<th class=\"has-text-centered\">\n\t\t\t\t\t\t\t\t", "\n\t\t\t\t\t\t\t\t</th>\n\t\t\t\t\t\t\t"], ["\n\t\t\t\t\t\t\t\t<th class=\"has-text-centered\">\n\t\t\t\t\t\t\t\t", "\n\t\t\t\t\t\t\t\t</th>\n\t\t\t\t\t\t\t"])), index ? index + minOffset : '');
  }), strings.reverse().map(function (x, index) {
    return lit_html_1.html(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n\t\t\t\t\t\t<tr>\n\t\t\t\t\t\t\t", "\n\t\t\t\t\t\t\t", "\n\t\t\t\t\t\t\t", "\n\t\t\t\t\t\t</tr>\n\t\t\t\t\t"], ["\n\t\t\t\t\t\t<tr>\n\t\t\t\t\t\t\t", "\n\t\t\t\t\t\t\t", "\n\t\t\t\t\t\t\t", "\n\t\t\t\t\t\t</tr>\n\t\t\t\t\t"])), Array(Math.max(0, x.offset + minOffset * -1)).fill('').map(function (x) {
      return lit_html_1.html(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n\t\t\t\t\t\t\t\t<td class=\"has-background-grey\"></td>\n\t\t\t\t\t\t\t"], ["\n\t\t\t\t\t\t\t\t<td class=\"has-background-grey\"></td>\n\t\t\t\t\t\t\t"])));
    }), x.range.map(function (y, i) {
      return i ? lit_html_1.html(templateObject_4 || (templateObject_4 = __makeTemplateObject(["<td class=\"has-text-centered\">\n\t\t\t\t\t\t\t\t\t", "\n\t\t\t\t\t\t\t\t</td>"], ["<td class=\"has-text-centered\">\n\t\t\t\t\t\t\t\t\t", "\n\t\t\t\t\t\t\t\t</td>"])), noteDisplay(y.note)) : lit_html_1.html(templateObject_5 || (templateObject_5 = __makeTemplateObject(["<th class=\"fretboard-open-string has-text-centered\">\n\t\t\t\t\t\t\t\t\t", "\n\t\t\t\t\t\t\t\t</th>"], ["<th class=\"fretboard-open-string has-text-centered\">\n\t\t\t\t\t\t\t\t\t", "\n\t\t\t\t\t\t\t\t</th>"])), noteDisplay(y.note));
    }), Array(Math.max(0, numberOfFrets + 1 - x.range.length - Math.max(0, x.offset + minOffset * -1))).fill('').map(function (x) {
      return lit_html_1.html(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n\t\t\t\t\t\t\t\t<td></td>\n\t\t\t\t\t\t\t"], ["\n\t\t\t\t\t\t\t\t<td></td>\n\t\t\t\t\t\t\t"])));
    }));
  }), Array(numberOfFrets + 1).fill('').map(function (x, index) {
    return lit_html_1.html(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n\t\t\t\t\t\t\t\t<th class=\"has-text-centered\">\n\t\t\t\t\t\t\t\t\t", "\n\t\t\t\t\t\t\t\t</th>\n\t\t\t\t\t\t\t"], ["\n\t\t\t\t\t\t\t\t<th class=\"has-text-centered\">\n\t\t\t\t\t\t\t\t\t", "\n\t\t\t\t\t\t\t\t</th>\n\t\t\t\t\t\t\t"])), !index || index % 12 ? [3, 5, 7, 9].indexOf(index % 12) > -1 ? unsafe_html_1.unsafeHTML('&bull;') : '' : unsafe_html_1.unsafeHTML('&bull; &bull;'));
  }));
};

var templateObject_1, templateObject_2, templateObject_3, templateObject_4, templateObject_5, templateObject_6, templateObject_7, templateObject_8, templateObject_9;
},{"./constants":"src/constants.ts","lit-html":"node_modules/lit-html/lit-html.js","lit-html/directives/unsafe-html":"node_modules/lit-html/directives/unsafe-html.js"}],"src/config.ts":[function(require,module,exports) {
"use strict";
...
var constants_1 = require("./constants"); // TODO: Move.
...
exports.config = {
  strings: exports.instruments.guitar_EADGBE.slice(),
  sharps: true,
  flats: true,
  activeNotes: constants_1.pitchClass.slice()
};
/**
 * Generate octaves down to A0 (we start at octave 4 by default, hence the negative numbers).
 */

exports.lookup = [-4, -3, -2, -1, 0, 1, 2, 3].map(constants_1.generateLookup).reduce(function (p, c) {
  return p.concat(c);
});
exports.lookup.forEach(function (x) {
  console.log(x.note, x.octave, x.pitch);
});

exports.createStringRanges = function () {
  return exports.config.strings.map(function (x) {
    var start = exports.lookup.findIndex(function (y) {
      return y.note === x.note && y.octave === x.octave;
    });
    return {
      note: x.note,
      octave: x.octave,
      frets: x.frets,
      offset: x.offset,
      range: exports.lookup.slice(start, start + x.frets + 1)
    };
  });
};

exports.getActiveNotes = function () {
  return exports.config.activeNotes;
};
},{"./constants":"src/constants.ts"}],"src/config/view.ts":[function(require,module,exports) {
"use strict";
...
exports.configViewTemplate = function (_a) {
  var remove = _a.remove,
      update = _a.update,
      add = _a.add;
  return lit_html_1.html(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n\t<section class=\"section\" id=\"config\">\n\t\t<div class=\"container\">\n\t\t<ol reversed=\"reversed\" class=\"is-unstyled\" style=\"counter-reset: li ", "\">\n\t\t", "\n\t\t</ol>\n\n\t\t<button type=\"button\" class=\"button is-primary is-fullwidth\" @click=", ">Add String</button>\n\t\t</div>\n\t</section>\n"], ["\n\t<section class=\"section\" id=\"config\">\n\t\t<div class=\"container\">\n\t\t<ol reversed=\"reversed\" class=\"is-unstyled\" style=\"counter-reset: li ", "\">\n\t\t", "\n\t\t</ol>\n\n\t\t<button type=\"button\" class=\"button is-primary is-fullwidth\" @click=", ">Add String</button>\n\t\t</div>\n\t</section>\n"])), config_1.config.strings.length + 1, config_1.config.strings.map(function (x, index) {
    return lit_html_1.html(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n\t\t\t<li class=\"is-relative\">\n\t\t\t\t<div class=\"string-config box\">\n\t\t\t\t\t<div class=\"columns is-relative\">\n\t\t\t\t\t\t<div class=\"column\">\n\t\t\t\t\t\t\t<label for=\"note-", "\">String Tuning</label>\n\t\t\t\t\t\t\t<div class=\"select is-small is-fullwidth\">\n\t\t\t\t\t\t\t\t<select id=\"note-", "\" @change=", ">\n\t\t\t\t\t\t\t\t\t", "\n\t\t\t\t\t\t\t\t</select>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class=\"columns is-relative\">\n\t\t\t\t\t\t<div class=\"column\">\n\t\t\t\t\t\t\t<label for=\"octave-", "\">Octave</label>\n\t\t\t\t\t\t\t<input id=\"octave-", "\" class=\"input is-small\" type=\"number\" .value=", "  @change=", " />\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div class=\"column\">\n\t\t\t\t\t\t\t<label for=\"frets-", "\">Number of Positions</label>\n\t\t\t\t\t\t\t<input id=\"frets-", "\" class=\"input is-small\" type=\"number\" min=\"0\" .value=", " @change=", " />\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div class=\"column\">\n\t\t\t\t\t\t\t<label for=\"offset-", "\">String Offset</label>\n\t\t\t\t\t\t\t<input id=\"offset-", "\" class=\"input is-small\" type=\"number\" .value=", " @change=", " />\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div class=\"column\">\n\t\t\t\t\t\t\t<button class=\"button is-danger is-fullwidth\" type=\"button\" @click=", ">\n\t\t\t\t\t\t\t\tRemove String\n\t\t\t\t\t\t\t</button>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t</li>\n\t\t"], ["\n\t\t\t<li class=\"is-relative\">\n\t\t\t\t<div class=\"string-config box\">\n\t\t\t\t\t<div class=\"columns is-relative\">\n\t\t\t\t\t\t<div class=\"column\">\n\t\t\t\t\t\t\t<label for=\"note-", "\">String Tuning</label>\n\t\t\t\t\t\t\t<div class=\"select is-small is-fullwidth\">\n\t\t\t\t\t\t\t\t<select id=\"note-", "\" @change=", ">\n\t\t\t\t\t\t\t\t\t", "\n\t\t\t\t\t\t\t\t</select>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class=\"columns is-relative\">\n\t\t\t\t\t\t<div class=\"column\">\n\t\t\t\t\t\t\t<label for=\"octave-", "\">Octave</label>\n\t\t\t\t\t\t\t<input id=\"octave-", "\" class=\"input is-small\" type=\"number\" .value=", "  @change=", " />\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div class=\"column\">\n\t\t\t\t\t\t\t<label for=\"frets-", "\">Number of Positions</label>\n\t\t\t\t\t\t\t<input id=\"frets-", "\" class=\"input is-small\" type=\"number\" min=\"0\" .value=", " @change=", " />\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div class=\"column\">\n\t\t\t\t\t\t\t<label for=\"offset-", "\">String Offset</label>\n\t\t\t\t\t\t\t<input id=\"offset-", "\" class=\"input is-small\" type=\"number\" .value=", " @change=", " />\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div class=\"column\">\n\t\t\t\t\t\t\t<button class=\"button is-danger is-fullwidth\" type=\"button\" @click=", ">\n\t\t\t\t\t\t\t\tRemove String\n\t\t\t\t\t\t\t</button>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t</li>\n\t\t"])), index, index, function (e) {
      x.note = e.target.value;
      update();
    }, constants_1.pitchClass.map(function (y) {
      return lit_html_1.html(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n\t\t\t\t\t\t\t\t\t\t<option .value=", " ?selected=", ">", "</option>\n\t\t\t\t\t\t\t\t\t"], ["\n\t\t\t\t\t\t\t\t\t\t<option .value=", " ?selected=", ">", "</option>\n\t\t\t\t\t\t\t\t\t"])), y, y == x.note.split(',')[0], y);
    }), index, index, x.octave, function (e) {
      x.octave = parseInt(e.target.value, 10);
      update();
    }, index, index, x.frets, function (e) {
      x.frets = parseInt(e.target.value, 10);
      update();
    }, index, index, x.offset, function (e) {
      x.offset = parseInt(e.target.value, 10);
      update();
    }, function () {
      return remove(index);
    });
...
},{"lit-html":"node_modules/lit-html/lit-html.js","../config":"src/config.ts","../constants":"src/constants.ts"}],"src/config/model.ts":[function(require,module,exports) {
"use strict";
...
/** @class */
function () {
  function ConfigViewModel(_a) {
    var _this = this;

    var viewTemplate = _a.viewTemplate,
        targetSelector = _a.targetSelector;

    this.add = function () {
      config_1.config.strings.push({
        note: 'C',
        offset: 0,
        octave: 3,
        frets: 24
      ...
      _this.update(); // stupid hack for now.

    };

    this.remove = function (index) {
      if (config_1.config.strings.length > 1) {
        config_1.config.strings.splice(index, 1);
  ...
  ConfigViewModel.prototype.render = function () {
    lit_html_1.render(this._viewTemplate(this), this._targetSelector());
  };

  ConfigViewModel.prototype.update = function () {};

  return ConfigViewModel;
}();

exports.ConfigViewModel = ConfigViewModel;
},{"../config":"src/config.ts","lit-html":"node_modules/lit-html/lit-html.js"}],"src/notes/view.ts":[function(require,module,exports) {
"use strict";
...
exports.noteViewTemplate = function (_a) {
  var remove = _a.remove,
      update = _a.update;
  return lit_html_1.html(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n\t<section class=\"section\" id=\"notes\">\n\t\t<div class=\"container\">\n\t\t\t<div class=\"columns\">\n\t\t\t\t<div class=\"column\">\n\t\t\t\t\t<div class=\"select is-fullwidth\">\n\t\t\t\t\t\t<select>\n\t\t\t\t\t\t\t<option>Choose a key</option>\n\t\t\t\t\t\t</select>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t\t<div class=\"column\">\n\t\t\t\t\t<div class=\"chromaticcircle\">\n\t\t\t\t\t\t", "\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</div>\n\t</section>\n"], ["\n\t<section class=\"section\" id=\"notes\">\n\t\t<div class=\"container\">\n\t\t\t<div class=\"columns\">\n\t\t\t\t<div class=\"column\">\n\t\t\t\t\t<div class=\"select is-fullwidth\">\n\t\t\t\t\t\t<select>\n\t\t\t\t\t\t\t<option>Choose a key</option>\n\t\t\t\t\t\t</select>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t\t<div class=\"column\">\n\t\t\t\t\t<div class=\"chromaticcircle\">\n\t\t\t\t\t\t", "\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</div>\n\t</section>\n"])), constants_1.octaveNotes.map(function (x, i) {
    return lit_html_1.html(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n\t\t\t\t\t\t\t<label class=\"button b", " ", "\">\n\t\t\t\t\t\t\t\t<span>", "</span>\n\t\t\t\t\t\t\t\t<input type=\"checkbox\" class=\"is-sr-only\" .value=", " />\n\t\t\t\t\t\t\t</label>\n\t\t\t\t\t\t"], ["\n\t\t\t\t\t\t\t<label class=\"button b", " ", "\">\n\t\t\t\t\t\t\t\t<span>", "</span>\n\t\t\t\t\t\t\t\t<input type=\"checkbox\" class=\"is-sr-only\" .value=", " />\n\t\t\t\t\t\t\t</label>\n\t\t\t\t\t\t"])), i + 1, x.indexOf(',') > -1 ? 'button-blackkey' : 'button-whitekey', x.replace(',', '/'), x);
  }));
};

var templateObject_1, templateObject_2;
},{"lit-html":"node_modules/lit-html/lit-html.js","../constants":"src/constants.ts"}],"src/notes/model.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  NoteViewModel.prototype.render = function () {
    lit_html_1.render(this._viewTemplate(this), this._targetSelector());
  };

  NoteViewModel.prototype.update = function () {};

  return NoteViewModel;
}();

exports.NoteViewModel = NoteViewModel;
},{"../config":"src/config.ts","lit-html":"node_modules/lit-html/lit-html.js"}],"node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
var fretboard_1 = require("./fretboard");

var view_1 = require("./config/view");

var model_1 = require("./config/model");

var view_2 = require("./notes/view");

var model_2 = require("./notes/model");
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var fretboardContainer = document.createElement('div');
  var configViewModel = new model_1.ConfigViewModel({
    viewTemplate: view_1.configViewTemplate,
    targetSelector: function targetSelector() {
      return configContainer;
    }
  }); // dumb hack. Fix later.

  configViewModel.update = function () {
    lit_html_1.render(fretboard_1.fretboard(config_1.createStringRanges(), config_1.config.activeNotes), fretboardContainer);
  };

  configViewModel.render();
  var noteViewModel = new model_2.NoteViewModel({
    viewTemplate: view_2.noteViewTemplate,
    targetSelector: function targetSelector() {
      return notesContainer;
    }
  });

  noteViewModel.update = function () {
    lit_html_1.render(fretboard_1.fretboard(config_1.createStringRanges(), config_1.config.activeNotes), fretboardContainer);
  };

  noteViewModel.render();
  lit_html_1.render(fretboard_1.fretboard(config_1.createStringRanges(), config_1.config.activeNotes), fretboardContainer);
  lit_html_1.render(template(fretboardContainer, notesContainer, configContainer), document.getElementById('application'));
});

var template = function template(fretboardContainer, notesContainer, configContainer) {
  return lit_html_1.html(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n\t", "\n\t<div hidden class=\"tabs is-fullwidth\">\n\t\t<ul>\n\t\t\t<li ?hidden=\"", "\" class=\"is-active\">\n\t\t\t\t<a>\n\t\t\t\t\t<span class=\"icon is-small\">\n\t\t\t\t\t\t<i class=\"fas fa-music\"></i>\n\t\t\t\t\t</span>\n\t\t\t\t\tNotes/scale\n\t\t\t\t</a>\n\t\t\t</li>\n\t\t\t<li ?hidden=\"", "\" class=\"is-active\">\n\t\t\t\t<a>\n\t\t\t\t\t<span class=\"icon is-small\">\n\t\t\t\t\t\t<i class=\"fas fa-cog\"></i>\n\t\t\t\t\t</span>\n\t\t\t\t\tFretboard Configuration\n\t\t\t\t</a>\n\t\t\t</li>\n\t\t\t<li ?hidden=\"", "\" class=\"is-active\">\n\t\t\t\t<a>\n\t\t\t\t\t<span class=\"icon is-small\">\n\t\t\t\t\t\t<i class=\"fas fa-cog\"></i>\n\t\t\t\t\t</span>\n\t\t\t\t\tSettings\n\t\t\t\t</a>\n\t\t\t</li>\n\t\t</ul>\n\t</div>\n\t", "\n\t", "\n"], ["\n\t", "\n\t<div hidden class=\"tabs is-fullwidth\">\n\t\t<ul>\n\t\t\t<li ?hidden=\"", "\" class=\"is-active\">\n\t\t\t\t<a>\n\t\t\t\t\t<span class=\"icon is-small\">\n\t\t\t\t\t\t<i class=\"fas fa-music\"></i>\n\t\t\t\t\t</span>\n\t\t\t\t\tNotes/scale\n\t\t\t\t</a>\n\t\t\t</li>\n\t\t\t<li ?hidden=\"", "\" class=\"is-active\">\n\t\t\t\t<a>\n\t\t\t\t\t<span class=\"icon is-small\">\n\t\t\t\t\t\t<i class=\"fas fa-cog\"></i>\n\t\t\t\t\t</span>\n\t\t\t\t\tFretboard Configuration\n\t\t\t\t</a>\n\t\t\t</li>\n\t\t\t<li ?hidden=\"", "\" class=\"is-active\">\n\t\t\t\t<a>\n\t\t\t\t\t<span class=\"icon is-small\">\n\t\t\t\t\t\t<i class=\"fas fa-cog\"></i>\n\t\t\t\t\t</span>\n\t\t\t\t\tSettings\n\t\t\t\t</a>\n\t\t\t</li>\n\t\t</ul>\n\t</div>\n\t", "\n\t", "\n"])), fretboardContainer, !flags.notesConfig, !flags.fretboardConfig, !flags.settingsConfig, flags.notesConfig ? notesContainer : '', flags.fretboardConfig ? configContainer : '');
};

var templateObject_1;
},{"lit-html":"node_modules/lit-html/lit-html.js","./fretboard":"src/fretboard.ts","./config/view":"src/config/view.ts","./config/model":"src/config/model.ts","./notes/view":"src/notes/view.ts","./notes/model":"src/notes/model.ts","@fortawesome/fontawesome-free/css/all.css":"node_modules/@fortawesome/fontawesome-free/css/all.css","./config":"src/config.ts"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
